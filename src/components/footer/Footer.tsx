  ...
  return (
    <div className="w-full mt-auto bg-gray-800 text-white p-6 flex flex-col items-center justify-center gap-6">
      <div className="flex items-center gap-4 text-4xl">
        ...
        {/* About Icon */}
        <Link to="/about"><i className="fas fa-info-circle icon cursor-pointer hover:bg-gradient-to-br hover:from-blue-500 hover:to-fuchsia-600 hover:bg-clip-text"></i></Link>
        {/* LinkedIn e GitHub Icons */}
