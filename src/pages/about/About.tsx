const AboutUs = () => {
  return (
    ...
    <section className="hero py-12 bg-fixed bg-cover bg-no-repeat bg-center relative" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1516211697506-8360dbcfe9a4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90oy1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'}}>
    ...
    <div className="flex justify-end h-full relative z-10">
      <div className="p-6 md:p-12 ">
        ...
        <p className="text-lg text-gray-800 leading-relaxed">
          Bem-vindo a <span className="font-semibold text-lime-950">ecoFamily</span>, onde a paixão pelos produtos locais e a dedicação aos pequenos produtores se entrelaçam para criar uma experiência de compras única...
        </p>
